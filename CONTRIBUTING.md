...
into `Plugins/SuperFAISSUnreal/Source/ThirdParty/SuperFAISS/` — see
...
- Run the coherence checks locally: `python Plugins/SuperFAISSUnreal/ci/check_*.py
...
`Plugins/SuperFAISSUnreal/CHANGELOG.md`, the vendored core's `version.h`, and the
