...
**Current release: [v3.3.0](https://github.com/dansupergameprogrammer/superfaiss-unreal/releases/tag/v3.3.0)**, bundling core [v3.3.0](https://github.com/dansupergameprogrammer/superfaiss/releases/tag/v3.3.0) — see [CHANGELOG.md](Plugins/SuperFAISSUnreal/CHANGELOG.md), and [VENDORED_VERSION.txt](Plugins/SuperFAISSUnreal/Source/ThirdParty/SuperFAISS/VENDORED_VERSION.txt) for the exact core commit. Version markers in this file record when a capability landed, not the current version.
